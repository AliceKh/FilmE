...
import {BackHandler, Dimensions, FlatList, Image, Modal, StyleSheet, Text, TouchableOpacity, View} from 'react-native';
import axios from 'axios';
import GraphPage from './GraphPage';
import {getEmail} from "../services/StayLoggedInService";
...
export default class ProfileScreen extends React.Component {
    ...
    componentDidMount() {
        ...
        console.log(data);
        axios.get(`http://${global.server}:4000/profileuser`, {data: data})
            .then(response => {
                ...
                >
                    <View style={styles.modalContent}>
                        <GraphPage objectId={this.state.selectedImageId}
                                   onClose={() => this.setState({isGraphVisible: false})}/>
                    </View>
                </TouchableOpacity>
            </Modal>
        );
        ...
        return (
            ...
            >
                ...
                <View style={styles.header}>
                    <TouchableOpacity
                        onPress={() => this.props.navigation.navigate('ExplorePage', {previousRouteName: 'ProfilePage'})}>
                ...
                <View style={{alignItems: 'center', marginTop: 16}}>
                    <Image source={user && {uri: user.ProfileImage}}
                ...
                {showList ? (
                    <View style={styles.container}>
                        <FlatList data={this.state.songs} renderItem={this.renderItem} keyExtractor={(item) => item.id}
                                  numColumns={3}/>
                    </View>
                ) : (
